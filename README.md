The code was tested on the cluster. To run the code, you need to modify the hello.pbs file to navigate to the directory where the code is located and then execute the .pbs file.
